...
# npm run cli -- generate-cnc -o build/test_cnc_foam_rough.nc examples/test_foam_rough.mill
# npm run cli -- generate-cnc -o build/test_cnc_foam_finish.nc examples/test_foam_finish.mill
